...
const OMAMORI_LIST = [
  ...
  },
  {
    ...
    emoji: "🌻",
    photos: [
      "./assets/omamori/阿部華也子/_93A1220.jpg",
    ],
    ...
    contents: [
      ...
      { id: 2, type: "image", title: "サンシャインショット", locked: true, date: "---", imgSrc: "" },
    ],
    titles: [
  ...
  },
  {
    ...
    emoji: "🌊",
    photos: [
      "./assets/omamori/潮紗理菜/_93A1220.jpg",
    ],
    oshi_msg: "波のように力強く前へ🌊\n一緒に進もう！",
    luckPoints: 60,
    maxPoints: 400,
    ...
    contents: [
      ...
      { id: 2, type: "image", title: "サマーショット", locked: true, date: "---", imgSrc: "" },
    ],
    titles: [
  ...
  },
  {
    ...
    emoji: "🔮",
    photos: [
      "./assets/omamori/林佑香/_93A1220.jpg",
    ],
    ...
    contents: [
      ...
      { id: 2, type: "image", title: "ミスティックショット", locked: true, date: "---", imgSrc: "" },
    ],
    titles: [
  ...
  },
  {
    ...
    emoji: "🍀",
    photos: [
      "./assets/omamori/森千晴/_93A1220.jpg",
    ],
    ...
    contents: [
      ...
      { id: 2, type: "image", title: "グリーンショット", locked: false, date: "1月20日", imgSrc: "" },
      { id: 3, type: "voice", title: "おやすみボイス", locked: true, date: "---", desc: "" },
    ],
    titles: [
  ...
  },
  {
    ...
    emoji: "🍊",
    photos: [
      "./assets/omamori/皆藤愛子/_93A1220.jpg",
    ],
    ...
    contents: [
      ...
      { id: 2, type: "image", title: "オレンジショット", locked: true, date: "---", imgSrc: "" },
    ],
    titles: [
